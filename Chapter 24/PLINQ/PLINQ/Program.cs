...
namespace PLINQ
{
    class Program
    {
        ...
        public static void Test1()
        {
            ...
            //A LINQ query that retrieves all numbers that are greater than 100
            ...
            Console.WriteLine($"There are over {numbersOver100.Count()} numbers over 100");
        ...
        public static void Test2()
        {
            ...
            try
            {
                ...
                List<OrderInfo> oderInfo = new List<OrderInfo>(orderInfoQuery);

                long milliseconds = timer.ElapsedMilliseconds;
                timer.Stop();

                // Displaying the results
                Console.WriteLine($"There are {oderInfo.Count()} oders");
